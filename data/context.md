...
- Access to Hiisi Base (for Anvil)
- Ability to triangulate locations using Jungle statues

**Discovery Clues:**
- Hand statues are visible in Snowy Depths but their purpose is not immediately obvious
- Breaking them reveals their function

**Step 0 - Quest Discovery:** Where snow falls eternal, stone hands grasp at emptiness. Three must break before the broken reveals itself.
...
**Rewards:**
- Summon Portal spell (permanent unlock)
- Access to steel chest with unique rewards

**Difficulty Rating:** High

---

## The Cessation Quest (Sky Temples Quest Chain)
...
- Access to various surface locations
- Understanding of potion mechanics

**Discovery Clues:**
- Temples are visible in the sky above various locations
- **Adept's Note** book in Barren Temple hints at Divine Ground mechanics
- Temples contain glyphs that provide visual clues

**Step 0 - Quest Discovery:** Four temples float, yet one stands empty. Begin where nothing grows, and the cycle shall reveal itself.
...
2. **Awaken Ten Potion Mimics at Henkevä Temple**
   ...
   - Hint to find next step: Where sky reflects in water, a chamber waits. Perhaps it hungers for what you can create.
...
5. **Obtain Urine**
    ...
    - Notes: Touch of Gold? spell transmutes everything in a short radius into urine. Destroying a significant portion of the Huussi reveals the spell. Urine can also be found in jars/flasks as rare drops.
...
6. **Apply Urine to Divine Ground**
    ...
    - Hint to find next step: The cycle completes, yet something remains unspoken, with ancient bones far below.
...
**Rewards:**
- Sea of Mimicium spell
- Touch of Grass spell
- Cessation spell (permanent unlock)
- Healium creation knowledge
...
- Tripping status effect (at least 180 seconds duration)
- Paha Silmä (Evil Eye)
- Access to Moon and Dark Moon
- Moon Radar perk (helpful but not required)

**Discovery Clues:**
- **Notes on Grand Alchemy** books at each fungal altar provide step-by-step guidance
- Stone mushroom structure below Desert Chasm reveals map when under Tripping effect
- Each fungal altar provides a notebook with specific instructions

**Step 0 - Quest Discovery:** Among the greatest works, one calls for a seed of promise. But to see the path, you must first see beyond seeing. Where stone fungus grows beneath the chasm, enter while your mind walks in strange places.

**Steps:**

### Phase 1: Discovery and Preparation

1. **Obtain Tripping Status Effect**
   - Location: Various - Can be obtained from consuming certain materials or spells
   - Difficulty: Medium - Requires finding source of Tripping
   - Prerequisites: None
   - Notes: Need at least 180 seconds duration. Can be extended with modifiers
   - Hint to find next step: When vision shifts and worlds blur, seek where earth cracks open. Stone growth marks hidden paths.

2. **Reveal Fungal Altar Map at Stone Mushroom Structure**
   - Location: Below Desert Chasm (Desert area) - Large stone mushroom structure contains tunnel
   - Difficulty: Medium - Requires exploration
   - Prerequisites: Must have Tripping status effect (180+ seconds)
   - Notes: Enter tunnel while Tripping - interior transforms to Rainbow Liquid, revealing map of fungal altar locations
...
9. **Find Auringonsiemen (Sun Seed)**
    - Location: Hidden deep within the soil (specific location from Book S_A)
    - Difficulty: Very High - Requires following clues from fungal altar books
...
15. **Imbue Youngling with All Four Essences**
    - Location: Various - Can be done anywhere
    - Difficulty: Very High - Requires all four Essences
    - Prerequisites: Must have Youngling and all four crystallized Essences
    - Notes: Creates Egg stage
    - Hint to find next step: An egg is born. It hungers for life itself - one hundred souls must feed it before the stone emerges.

### Phase 5: Life Force Consumption

16. **Allow Egg to Consume Life Force of 100 Foes**
    - Location: Various combat areas
    - Difficulty: High - Requires many enemy kills
    - Prerequisites: Must have Egg
    - Notes: Egg must be present during combat. After 100 kills, transforms to Stone
    - Hint to find next step: One hundred souls consumed. The egg hardens into stone. Now subject it to great heat, then carry it to where the first sun shone.

### Phase 6: Fire Transformation

17. **Subject Stone to Great Fire and Heat**
    - Location: Various - Areas with extreme heat/fire
    - Difficulty: Very High - Requires extreme temperatures
...
20. **Return Stone to Origin and Complete the Cycle**
...
- Uusi Aurinko (New Sun) - transforms world
- Access to new content and endings
...
- Ability to obtain a fish
- Access to Anvil in Hiisi Base
- Access to Master of Masters location
- Access to Kantele location

**Discovery Clues:**
- Fish can be found in many water bodies
- Mountain Altar is visible above starting area
- Quest references Finnish creation myth *Kalevala*

**Step 0 - Quest Discovery:** Above the mountain where you began, a stone awaits an offering from below. Give it a creature of water, and rain shall answer. From bone shall come power, and from bone and song shall come the sea that drowns even masters.

**Steps:**

1. **Obtain a Fish (Eväkäs)**
   - Location: Any water body containing fish - Lakes, pools, Holy Mountain pools, etc.
   - Difficulty: Easy - Fish are common in water areas
   - Prerequisites: None
   - Notes: Fish can be found in many locations. Holy Mountain pools contain fish equal to number of Orbs collected
...
8. **Obtain Second Hauen Leukaluu (If Needed)**
   - Location: Mountain Altar (781, -1167) - Requires new Fish Rain
   - Difficulty: Medium - Must complete Fish Rain again
   - Prerequisites: Must have used first Hauen Leukaluu
   - Notes: Only needed if you want both Summon Fish and Sea of Swamp. Can use Polymorphine/duplication instead
...
11. **Defeat Master of Masters**
    ...
    - Hint to find next step: The master falls. When power changes hands, wands remember who commands them.

**Rewards:**
- Summon Fish spell (permanent unlock)
- Sea of Swamp spell (permanent unlock)
- Wand Homing spell (permanent unlock)
- Hauen Leukaluu wand (temporary, consumed)

**Difficulty Rating:** High

**Trivia:** The quest references the Finnish creation myth *Kalevala*, where the wizard Väinämöinen plays a bone kantele and defeats a challenger by "singing them into a swamp."

---

## The Coral Crystal Key Quest
...
- Access to four Music Machine locations
- Ability to transport the Crystal Key
...
- Divide By 3 spell (permanent unlock)
- Divide By 4 spell (permanent unlock)
- Octuple Spell (permanent unlock)
- Myriad Spell (permanent unlock)
...
- Coral Chest can still be opened after triggering Pure Ending

---

## The Dark Crystal Key Quest
...
**Prerequisites:**
- Ability to defeat High Alchemist
- Access to Overgrown Cavern (for Alchemist's Notebook)
- Access to Kantele and Huilu (Ocarina) instruments
- Knowledge of note spells
- Access to The Work (Hell)
...
5. **Learn Note Spells**
   - Location: Various - Note spells can be found in spell shops or as drops
   - Difficulty: Medium - Requires finding note spells
   - Prerequisites: Must have Kantele and/or Huilu
   - Notes: Need note spells to play melodies. Can use Kantele/Huilu items directly or note spells
   - Hint to find next step: Notes mastered. Set key upon ground and play the string melody first.

6. **Play First Melody (Kantele) to Crystal Key**
   - Location: Anywhere - Key must be on ground nearby
   - Difficulty: Medium - Requires knowledge of note sequence
   - Prerequisites: Must have Kantele (or Kantele note spells) and Crystal Key
   - Notes: Play sequence: G D# G E A. After first song, message appears: "The key begins to hum! Something is still missing..."
   - Hint to find next step: The key responds, but something is missing. Perhaps another melody completes it. Perhaps wind must join strings.

7. **Play Second Melody (Huilu) to Crystal Key**
   - Location: Anywhere - Key must be on ground nearby
   - Difficulty: Medium - Requires knowledge of note sequence
...
- Spells To Giga Sawblades (permanent unlock)
- Spells To Magic Missiles (permanent unlock)
- Spells To Death Crosses (permanent unlock)
- Spells To Black Holes (permanent unlock)
- Spells To Acid (permanent unlock)
- Copy Trail (permanent unlock)
...
- Key must be on ground (not held) when playing melodies to it
...
- Most quests require extensive exploration and preparation
- Save frequently and be prepared for difficult encounters
- Some quests require items from other quests (e.g., instruments, spells)
- Coordinate locations are approximate - use the NoitaMap for precise locations
- Many quests have permanent effects on future playthroughs
- Some quests can be completed in parallel if prerequisites are met
- Books and tablets often provide crucial clues - read them carefully
- Status effects (like Tripping) are often required for quest progression
- Transporting items safely is crucial - use appropriate spells and methods
...
| Name | Location (x, y) | Size (width × height) | Spell Tiers | Description | Hazards | Notable Enemies |
|------|----------------|----------------------|-------------|-------------|---------|----------------|
| Mines | -3, 0 | 7 × 2 | Wands: [0], Spell Shops: [1], Holy Mountain: [0, 0] | The first underground biome, characterized by wooden structures and mining equipment. Features tight passages and various enemies. | Explosive barrels, wooden structures that can collapse, limited visibility | Hiisi, Rats, Mages |
| Coal Pits | -4, 3 | 8 × 2 | Wands: [0, 1], Spell Shops: [2], Holy Mountain: [0, 1] | Deeper mining area with coal veins and increased fire hazards. More open than Mines with coal deposits throughout. | Explosive boxes, coal fires, propane tanks, fire hazards | Hiisi variants, Fire Mages, Tank enemies |
| Snowy Depths | -5, 6 | 10 × 3 | Wands: [1], Spell Shops: [3], Holy Mountain: [1, 2] | Third biome on main path, first snow-themed area. Large formations of snow and frozen rock connected by fragile ice. Open passages with bodies of water. | Open terrain allows ranged attacks, explosive boxes, propane tanks, fragile ice | Hiisi variants, Tanks, Thunder Mages, Thunder Spirits |
| Hiisi Base | -4, 10 | 7 × 2 | Wands: [2], Holy Mountain: [1, 2] | Industrial-themed biome with metal structures, conveyor belts, and advanced Hiisi technology. Heavily fortified area. | Numerous explosives, turrets, hazardous materials, metal structures | Advanced Hiisi soldiers, Hiisi Healers, Hiisi Gunners |
| Underground Jungle | -5, 13 | 9 × 3 | Wands: [1, 2, 3, 4], Holy Mountain: [2, 3] | Dense jungle environment with hazardous plants and aggressive wildlife. Terrain similar to Coal Pits with more dropshafts and dense vegetation. | Toxic plants, acid pools, fast-growing poisonous buds, trees become solid obstacles | Large spiders, hardened Hiisi troops, jungle creatures |
| The Vault | -6, 17 | 11 × 3 | Wands: [2, 3, 4], Spell Shops: [4], Holy Mountain: [3, 4] | High-tech facility with advanced security systems and robotic enemies. Features control rooms and storage areas. | Laser traps, turrets, security systems, mechanical hazards | Robotic enemies, security systems, advanced constructs |
| Temple of the Art | -9, 21 | 14 × 4 | Wands: [4, 5], Spell Shops: [5], Holy Mountain: [5, 6] | Mystical temple filled with magical traps and powerful enemies. Final main path biome before The Work. | Magical barriers, spell-casting enemies, cursed areas, magical traps | Powerful wizards, spellcasters, magical constructs |

### Side Biomes

| Name | Location (x, y) | Size (width × height) | Spell Tiers | Description | Hazards | Notable Enemies |
|------|----------------|----------------------|-------------|-------------|---------|----------------|
| Fungal Caverns | -7, 3 | 3 × 2 | Wands: [0, 1] | Mushroom-themed biome located west of Coal Pits. Tight passages lined with steel beams. Rich in fungi including explosive varieties. | Default "Humid" biome modifier (projectile deceleration), explosive fungi, toxic rock caves, flammable materials | Turso, Pikkuturso, Robottikyttä |
| Lukki Lair | -12, 11 | 7 × 9 | Wands: [2, 3, 4] | Massive cave system filled with Lukki spiders. Connects to Underground Jungle. Dangerous area with web-covered passages. | Dense webs, tight passages, multiple Lukki spawns | Various Lukki types, large spiders |
| Frozen Vault | -23, 1 | 7 × 5 | Wands: [2, 3, 4] | Frozen underground vault located in Snowy Wasteland. Contains valuable loot and challenging enemies. | Ice hazards, cold damage, frozen structures | Ice enemies, frozen constructs |
| Overgrown Cavern | 24, 2 | 7 × 9 | Wands: [2, 3, 4] | Massive fungus-infested area beneath Desert, east of Pyramid. Known as "Wandmart" for high-tier wands and numerous chests. | Explosive fungi (including acid-splashing green variant), Prickly Spore Pods, highly flammable, acid pools | Fungal creatures that explode violently on death |
| Power Plant | 24, 16 | 7 × 9 | Wands: [2, 3, 4] | Industrial-themed biome beneath eastern Sandcave. Winding corridors with dense steel and resistant materials. Houses Kolmisilmän Silmä miniboss. | Plasma beam traps, electrical hazards, dense materials difficult to dig through | Kolmisilmän Silmä (miniboss), robotic enemies |
| Wizards' Den | 12, 22 | 13 × 10 | Wands: [4, 5] | Area filled with powerful wizards and magical enemies. Contains high-tier spells and dangerous encounters. | Magical traps, spell hazards, powerful enemies | Master Wizards, powerful spellcasters |

### Special Areas

| Name | Location (x, y) | Size (width × height) | Spell Tiers | Description | Hazards | Notes |
|------|----------------|----------------------|-------------|-------------|---------|-------|
| The Work (Sky) | -8, -48 | 15 × 35 | Spell Shops: [10] | Massive area high in the sky. Contains shops and special content. Extreme altitude. | Falling hazards, extreme altitude, limited oxygen | Requires flight or teleportation to access |
| The Work (Hell) | -8, 37 | 15 × 36 | Spell Shops: [10] | Final biome deep underground. Extreme heat and danger. Contains The End of Everything room. | Extreme heat, lava, powerful enemies, world-ending mechanics | Extreme difficulty, endgame content |
| Meditation Chamber | -9, 4 | 1 × 1 | Wands: [1, 2] | Small chamber for meditation. Contains special content. | Minimal hazards | Special location |
| Buried Eye | 7, 8 | 1 × 1 | Wands: [1, 2] | Hidden location containing a buried eye. Special quest location. | Hidden location, may require digging | Quest-related location |
| Eye Room | -8, 10 | 1 × 1 | Spell Shops: [0-10] | Special room with eye-themed content. Contains spell shops with all tiers. | Minimal hazards | Unique spell shop location |
| Hiisi Base Spell Shop | -5, 10 | 1 × 1 | Spell Shops: [2] | Spell shop located within Hiisi Base. Tier 2 spells available. | Located in dangerous biome | Convenient shop location |

### Surface Locations

| Name | Location (x, y) | Size (width × height) | Description | Notes |
|------|----------------|----------------------|-------------|-------|
| Bunkers | -26, 0 | 2 × 2 | Military bunkers on the surface. May contain supplies. | Surface location |
| Celestial Scale | 25, -1 | 1 × 1 | Special location with celestial scale. Quest-related. | Surface location |
| Rainbow Trail | -28, -6 | 1 × 1 | Location of the Rainbow Trail spell. Surface area. | Surface location |
| Kantele | -4, -2 | 2 × 1 | Location of the Kantele instrument in Giant Tree. | Surface location, quest item |
...
- Location: West of Dark Cave
- Description: Perilous biome filled with traps, strong enemies, and pools of magical liquids
- Hazards: Ceiling laser traps (25 damage), hostile statues, dense Ruined Brick Wall
- Notable Enemies: Patsas (hostile statues), Epäalkemisti, Kadotettu alkemisti, Ylialkemisti (miniboss)
- Rewards: Reliable source of powerful magical liquids (Ambrosia, Berserkium)

**Lava Lake** (not in coordinate data, but important):
- Location: East of Mines
- Description: Vast area dominated by deep lava lake with Orb of True Knowledge at bottom
- Hazards: Amplified "Hot" modifier, materials ignite, water evaporates rapidly, solids melt into lava
- Points of Interest: Chasm on eastern bank leading to Snowy Depths

**Desert** (surface biome):
- Description: Barren landscape of sand and cacti, nearly devoid of enemies
...
This section shows the relative distances between biomes to help understand spatial relationships. Distances are calculated from biome center coordinates using Euclidean distance.

#### Main Path Sequence (Vertical Progression)
The main path biomes are arranged vertically, progressing downward:

1. **Mines** (-3, 0) → **Coal Pits** (-4, 3) - Distance: ~3.2 units
2. **Coal Pits** (-4, 3) → **Snowy Depths** (-5, 6) - Distance: ~3.2 units
3. **Snowy Depths** (-5, 6) → **Hiisi Base** (-4, 10) - Distance: ~4.1 units
4. **Hiisi Base** (-4, 10) → **Underground Jungle** (-5, 13) - Distance: ~3.2 units
5. **Underground Jungle** (-5, 13) → **The Vault** (-6, 17) - Distance: ~4.1 units
6. **The Vault** (-6, 17) → **Temple of the Art** (-9, 21) - Distance: ~5.0 units

#### Adjacent/Side Biomes

**Fungal Caverns** (-7, 3):
- Adjacent to: Coal Pits (-4, 3) - Distance: ~3.0 units (west)
- Adjacent to: Snowy Depths (-5, 6) - Distance: ~3.6 units (southwest)

**Lukki Lair** (-12, 11):
- Adjacent to: Hiisi Base (-4, 10) - Distance: ~8.1 units (west)
- Adjacent to: Underground Jungle (-5, 13) - Distance: ~7.1 units (west)
- Connects to Underground Jungle (game connection)

**Frozen Vault** (-23, 1):
- Isolated location, far west
- Nearest: Fungal Caverns (-7, 3) - Distance: ~16.5 units
- Nearest: Mines (-3, 0) - Distance: ~20.0 units

**Overgrown Cavern** (24, 2):
- Far east location
- Adjacent to: Power Plant (24, 16) - Distance: ~14.0 units (directly below)
- Nearest main path: Mines (-3, 0) - Distance: ~27.1 units

**Power Plant** (24, 16):
- Adjacent to: Overgrown Cavern (24, 2) - Distance: ~14.0 units (directly above)
- Adjacent to: Wizards' Den (12, 22) - Distance: ~13.4 units (northwest)
- Nearest main path: Underground Jungle (-5, 13) - Distance: ~29.1 units

**Wizards' Den** (12, 22):
- Adjacent to: Power Plant (24, 16) - Distance: ~13.4 units (southeast)
...
- Mines, Coal Pits, Snowy Depths, Hiisi Base, Underground Jungle, The Vault, Temple of the Art
- Tightly connected vertical progression

**West Side Biomes**:
- Fungal Caverns (near Coal Pits/Snowy Depths)
- Lukki Lair (near Hiisi Base/Underground Jungle)
- Frozen Vault (isolated far west)

**East Cluster**:
- Overgrown Cavern, Power Plant, Wizards' Den
- Isolated from main path, high-tier content

**Note:** Coordinates use a grid system where each unit represents a biome-sized area. Actual in-game distances may vary based on terrain and paths.
...
| Name | Aliases | Location (x, y) | Text |
|------|---------|----------------|------|
| Mountain Text secret message | Secret Message 9 | 783, -430 | "Devoted seeker after true wisdom know this we are watching you." |
| Holy Mountain 1 secret message | Secret Message 7 | 1883, 1336 | "Why? Why did you look here? What answers are you trying to find in here?" |
| Fungal Caverns 1 secret message | Secret Message 6 | 3502, 2663 | "We know what you are after. But it is not here, Knower to Be." |
| Under The Wand Cave secret message | Secret Message 10 | -4326, 4501 | "Why are you doing this? Why are you reading this? What do you think you will find in here? The answer to the treasure?" |
| Jungle Right secret message | Secret Message 8 | 2929, 6628 | "Why must you go destroying everything? Why? For glory? For your precious god of gods. Is it really worth all this? Is it? Is it really?" |
| Vault Inside secret message | Secret Message 11 | -1998, 8464 | "What do you worship? You don't even know it. You think you know the answer, but you don't. You think the treasure will satisfy you, but it won't. You don't even know what your [sic] seeking. You think you do, but you don't." |
| Crypt Left secret message | Secret Message 12 | -3967, 10551 | "You gave your free will to the true god. Why else would be here? Why else would be reading this? We wanted you to come here. We wanted you to read this! You think you have free will? We made you come here. We made you read this." |
| Boss Arena secret message | Secret Message 1 | 3588, 12703 | "Who do you worship? Who is your god? Your real god? You don't even know it. You don't even understand it. You understand so little that we pity you... poor little thing. You've come so far, yet you have so far to go. Or maybe you understand more than we think? You are reading this? Do you even know who your god is? Your true god? The god of gods, the one true god? You think we're the false god, but we created your god and your god of gods. Now who is the real god? If we've created your god and your god of gods and you and your free will and this world and all the worlds. All of it. We allowed you to have free will. You think you have free will. You poor thing. You don't. You think we are the monsters. We're not. Who is the real monster? Your god is, your god of gods is the real monster. Your true god is the real monster." |
| Boss Arena Under secret message | Secret Message 2 | 3089, 13720 | "You come here seeking answers? You think we have all the answers? We don't not. You think we are so different. We are the same. We both serve the same god. The god of many gods. The god we've created. You think you're destroying us. You are not. You are helping us." |
| Boss Arena Under Right secret message | Secret Message 3 | 4328, 15097 | "You think you can destroy us? You will not destroy us. We gave you your free will. We made this place. And not just this place, all the places, all the dimensions, all the free wills. You think you've come to steal from us? No, we stole from you. We stole your time and your money and your sanity." |
| Completely Random secret message | Secret Message 4 | -5300, 21898 | "This is very clever of you. Very clever. We're impressed with you, Knower to Be." |
| Completely Random 2 secret message | Secret Message 5 | 4376, 26975 | "While we're impressed, we must ask you this is it really worth transcribing these? Do you really expect us the reveal the real secret? We can tell you this  it is possible but even we don't know how." |
...
Books in Noita provide cryptic hints and lore that guide players in uncovering the game's secrets. They are scattered throughout the world and offer insights into quests, mechanics, and hidden content.
...
These books are found at Fungal Altars and provide hints for the Sun Quest (Uusi Aurinko). They guide players through the steps needed to complete the quest involving the Auringonsiemen (Sun Seed).
...
Emerald Tablets are small green items found typically near Orbs of True Knowledge, containing game lore. When examined, tablets show their text in glowing green glyphs that slowly morph into readable text. Some tablets can be reforged into Stone Tablets at the Anvil in Hiisi Base (bottom right).

**Note:** Exact coordinates are not available in the source data. Locations are described by biome/area.

| Name | Location | Text | Reforgeable | Stone Tablet Text |
|------|----------|------|-------------|-------------------|
| Emerald Tablet of Thoth | On top of the Pyramid in the Desert | "The necessity of concealing the Art is one of the chief anxieties of alchemists. We are sworn to secrecy by heaven and earth and hell, By the four elements, by the height and the depth, By Hermes, by Anubis, and by the howlings of Kerkoros. An oath has been required of us to reveal nothing clearly to any uninitiated being." | Cannot | - |
| Secretorum Hermetis | Located in the Forest to the left in the giant tree above the Collapsed Mines | "The sacrifice of oneself to the pursuit of knowledge Is the highest tribute to the gods." | Cannot | - |
| Tabula Smaragdina | The right side of the Mines near the Lava Lake | "If all the mountains were of silver and gold, What would they profit a man who lives in constant fear of death? Hence there cannot be in the whole world anything better than our Medicine, Which has power to heal all the diseases of the flesh." | Cannot | - |
| Emerald Tablet - Volume I | Located high in the air directly above the starting Mountain inside the floating island, beneath the altar | "Tis true without lying, certain and most true. That which is below is like that which is above And that which is above is like that which is below To do the miracles of one only thing And as all things have been and arose From one by the mediation of one: So all things have their birth From this one thing by adaptation." | Cannot | - |
| Emerald Tablet - Volume II | At the bottom of the Frozen Vault | "Thence is born a spirit white as snow, And another spirit red as blood, Which two spirits are contained In a third hidden thing." | Yes | "The essence of life and death." |
| Emerald Tablet - Volume III | Located beneath the Lava Lake east of the Mines | "Heed my warning, or death and decay will follow." | Cannot | - |
| Emerald Tablet - Volume IV | At the bottom of the Sandcave | "The definition of death is the disjunction of the composite, But there is no disjunction of that which is simple, for it is one. Death consists in the separation of the soul from the body, Because anything formed out of two, three, or four components Must disintegrate, and this is death. Understand, further, That no complex substance which lacks fire eats, drinks, or sleeps, Because in all things which have a spirit fire is that which eats." | Yes | "Prove thine knowledge, from what is the west created of." |
| Emerald Tablet - Volume V | The left side of the Magical Temple | "And the Lord spake, saying, 'First shalt thou take out the Holy Pin. Then, shalt thou count to three. No more. No less. Three shalt be the number thou shalt count, And the number of the counting shall be three. Four shalt thou not count, neither count thou Two, excepting that thou then proceed to three. Five is right out. Once at the number three, Being the third number be reached, then, Lobbest thou thy Holy Hand Grenade of Antioch Towards thy foe, who, being naughty in My sight, Shall snuff it.'" | Yes | "Prove thine knowledge, from what the east is created of." |
| Emerald Tablet - Volume VI | Towards the bottom of the Lukki Lair | "Some Alchemists fancy that the work from beginning to end is a mere idle entertainment; But those who make it so will reap what they have sown -- nothing. We know that next to the Divine Blessing, and the discovery of the proper foundation, Nothing is so important as unwearied industry and perseverance in this First Operation. It is no wonder, then, that so many students of this Art are reduced to beggary; They are afraid of work, and look upon our Art as mere sport for their leisure moments. For no labour is more tedious than that which the preparatory part of our enterprise demands." | Yes | "To have true knowledge is to see the darkness of ignorance." |
| Emerald Tablet - Volume VII | Past the lava pool that Tabula Smaragdina can be found near, over a chasm, in The Orb Room | "Among those who devote themselves to the transmutation of metals, However, there can be no such thing as mediocrity of attainment. A person who studies this Art, must have either everything or nothing. An Alchemist who knows only half their craft, reaps nothing but disappointment And waste of time and money; moreover, they lay themselves open to the mockery of those who despise our Art. Those, indeed, who succeed in reaching the goal of the Magistery, have not only infinite riches, but the means of continued life and health. Hence it is the most popular of all pursuits." | Yes | "To gain true knowledge, one must slow down and not hurry." |
| Emerald Tablet - Volume VIII | In the middle of The Work (Hell) | "Woe unto all ye fools! How ignorant are ye of this Art, for which ye would die if ye knew it! I swear to you that if kings were familiar with it, none of us would ever attain this thing. O how this nature changeth body into spirit! O how admirable is Nature, how she presides over all, and overcomes all." | Yes | "Awaken, the flock of the shepherd and think for thyself!" |
| Emerald Tablet - Volume IX | In The Orb Room, located deep within the Snow Chasm | "In this way, then, Nature generates by means of this sulphur the different kinds of metals in the veins of the earth, according to the diversity of degrees and alterations." | Yes | "To walk a mile in someone else's boots." |
